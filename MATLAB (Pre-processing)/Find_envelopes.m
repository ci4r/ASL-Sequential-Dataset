...
subs = {'15 apr darrin', '15 apr ozgur', '16 apr devon asl2', '19 apr sevgi', '20 apr caroline', '21 apr blake', '21 apr emin', '22 apr ladi', '22 apr sean', '23 apr alperen', ...
        '23 apr mahbub', '19 apr sean'};
...
for i = 1:imax
   msg = strcat(['Processing: Subject ''', subject, ''', File: ', int2str(i), ' of ', int2str(imax)]);   % loading message
   disp(msg);
